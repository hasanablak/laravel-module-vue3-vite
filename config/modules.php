...
return [
    ...
    */
	'stubs' => [
		'enabled' => true,
		'path' => base_path('stubs/nwidart-stubs'), //vendor/nwidart/laravel-modules/src/Commands/stubs
		'files' => [
			...
			'assets/js/components/SayHello' => 'resources/assets/js/components/SayHello.vue',
			'assets/js/components/AsyncComp' => 'resources/assets/js/components/AsyncComp.vue',
		...
		'replacements' => [
			...
			'assets/js/components/SayHello'  => ['STUDLY_NAME'],
